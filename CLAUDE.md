...
src/components/
  ...
  workflows/          Workflow Pipeline (CRUD, execution, status)
...
- Accent: Cyan #06B6D4
- Monochrome: grays only, no color except cyan accent
- Framer Motion for transitions
- React Flow for agent hierarchy DAG
...
5. Dynamic imports for heavy deps (static imports only with Turbopack)
