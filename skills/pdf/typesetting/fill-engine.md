...
- [OK] **Body pages** (body pages of Report / Academic / Creative routes)
- [OK] **All three rendering routes** (ReportLab / LaTeX / Playwright-HTML)
- [X] **Not applicable to covers** (covers are independently controlled by `cover.md`)
- [X] **Not applicable to TOC pages** (TOC has a fixed format)
...
|--------|------|------|
| **≥ 80%** | [OK] Full | No adjustment, render normally |
| **65%–80%** | [!] Slightly empty | Light inflation (line-height + paragraph spacing only) |
...
│                          │     │                         │
└─────────────────────────┘     └─────────────────────────┘
      [X] No anchoring                      [OK] Golden ratio anchoring
```
