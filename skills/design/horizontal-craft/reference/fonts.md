...
正文/严肃内容禁用：
- [X] 华文彩云、华文琥珀、华文行楷
- [X] 任何带阴影/3D/塑料质感的"特效字体"
- [X] 装饰性毛笔字体（如造字工房悦圆系列做正文）
- [X] 游戏字体（暗黑、星际等）做长文
- [X] 楷体做现代长文正文（**儿童读物 / 教育例外**）—— 楷体笔画细易疲劳
- [X] 仿宋体做大段现代正文（**公文例外**）—— 同上
- [!] 中易宋体、中易仿宋、旧版微软雅黑：破折号/省略号可能断开或下沉，Web 与长文场景需测试
- [!] 华文黑体、部分兰亭黑版本：标点可能不居中；如用于出版/品牌项目需实测
