...
## [Target] 大盘复盘（需开启）
## [Chart] 个股决策仪表盘（每只）
   ### [icon] 重要信息速览（舆情/业绩预期/[ALERT]风险/[*]利好/最新动态）
   ### [Pin] 核心结论（结论/一句话/空仓者建议/持仓者建议+盈亏）
   ### [Trend] 当日行情
   ### [Chart] 数据透视（技术面/基本面/资金面）
   ### [Target] 作战计划（狙击点位表/仓位/风控）
   ### [OK] 检查清单（综合结论）
   ### [Money] 股息分析（美股，需开启 includeDividend）
```
...
| 提醒类型 | 触发条件 |
|---------|---------|
| [Target] 目标价 | 当前价 ≥ targetPrice |
| [STOP] 止损价 | 当前价 ≤ stopPrice |
| [Chart] 信号变化 | 本次结论 ≠ 上次结论 |
