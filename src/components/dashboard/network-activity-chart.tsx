...
export function NetworkActivityChart({ data: activityData }: { data?: number[] }) {
  ...
  return (
    <div data-src="src/components/dashboard/network-activity-chart.tsx" className="rounded-xl p-4 sm:p-6" style={{ background: 'rgba(45, 45, 45, 0.3)', border: '1px solid rgba(51, 51, 51, 0.5)' }}>
