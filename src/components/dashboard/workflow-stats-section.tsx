...
export function WorkflowStatsSection({ workflowsData, onOpenWorkflows }: { workflowsData: any; onOpenWorkflows?: () => void }) {
  ...
  return (
    <CollapsibleSection title="Workflow Pipeline" icon={<Workflow className="w-3.5 h-3.5" style={{ color: '#06B6D4' }} />} count={totalWorkflows} accentColor="#06B6D4" defaultOpen={true}>
