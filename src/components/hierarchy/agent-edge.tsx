...
function AgentEdgeComponent({
  ...
  return (
    <>
      ...
      {flowAnimation && (
        <EdgeParticles id={id} edgePath={edgePath} edgeType={edgeType} strength={strength} />
      )}
        ...
        <EdgeLabelRenderer>
          <div
            style={{
              ...
              fontSize: 8, fontWeight: 700, color: config.color,
              background: 'rgba(10,10,10,0.9)', padding: '1px 4px', borderRadius: 3,
              pointerEvents: 'none', border: `1px solid ${config.color}30`,
            }}
          >
            {config.label}
          </div>
